...
namespace MvcStudent.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string studentGender, string searchString)
        {
            ...
            var studentGenderVM = new StudentGenderViewModel
            {
                Genders = new SelectList(await genderQuery.Distinct().ToListAsync()),
                Students = await students.ToListAsync()
            };

            return View(studentGenderVM);
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Gender,Age,BirthDate,Phone,Temperature,Dateoffilling")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Gender,Age,BirthDate,Phone,Temperature,Dateoffilling")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
